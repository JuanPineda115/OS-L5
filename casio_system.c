...
// Retorna el valor entero del string ingresado
...
//Muestra las configuraciones del scheduler
...
//Vacia la informacion del scheduler
...
//Retorna la informacion del scheduler
...
//Escribe en un archivo la informacion del scheduler
...
//Inicia la ejecucion del scheduler
...
//finaliza la ejecucion del scheduler
...
//Muestra el archivo que esta siendo utilizado
void help(char* name)
{
...
int main(int argc, char *argv[])
{
	...
	//por cada task, ejecutar ./casio_task
	for(i=0;i<casio_tasks_num;i++){
